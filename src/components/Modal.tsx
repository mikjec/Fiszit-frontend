  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm mx-4 p-7 relative animate-[popIn_0.2s_cubic-bezier(.175,.885,.32,1.275)]">
        <button
          onClick={onClose}
          className="absolute top-4 right-4 w-7 h-7 flex items-center justify-center rounded-full text-gray-400 hover:text-gray-700 hover:bg-gray-100 transition-all"
        >
          <X className="w-4 h-4" />
        </button>
